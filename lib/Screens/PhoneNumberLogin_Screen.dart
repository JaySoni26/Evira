import 'package:evira_mark_2/Components/Bottoms_opt.dart';
import 'package:evira_mark_2/Screens/OtpVerification_Screen.dart';
...
class _PhoneNumberLogin_ScreenState extends State<PhoneNumberLogin_Screen> {
  TextEditingController phoneNumberController_PHL = TextEditingController();
  String phoneNumber_PHL = '';
  ...
  void initState() {
    super.initState();
    phoneNumberController_PHL = TextEditingController();
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Input_Box(
                ...
                controller: phoneNumberController_PHL,
              ),
              Spacer(),
              ...
              HorizontalButton(
                ...
                onPressed: () {
                  setState(() {
                    phoneNumber_PHL = phoneNumberController_PHL.text;
                  });
                  print('Phone number: $phoneNumber_PHL');
                  closeKeyboard(context);
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => OtpVerification_Screen(
                              PhoneNumber: phoneNumber_PHL,
                            )),
                  );
                },
                textColor: kWhite,
